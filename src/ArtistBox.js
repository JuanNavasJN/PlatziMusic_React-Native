...
export default class ArtistBox extends Component {
  ...
  getArtistRef = () => {
    ...
    //firebaseDatabase.ref('artist/' + id)
...
const styles = StyleSheet.create({
  ...
  artistBox: {
    ...
    flexDirection: 'row',
    shadowColor: 'black',    // solo funciona en ios
    shadowOpacity: .1,
    shadowOffset: {
      height: 1,
      width: -2,  // inidica que la sombra quede a la izquierda
    },
  ...
  info: {
    ...
    flexDirection: 'column',    // direccion de los objetos
    alignItems: 'center',
